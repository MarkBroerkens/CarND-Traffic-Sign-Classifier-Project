...
As a last step, I normalized the image data because the neural net works more gracefully, since the hidden activation functions don't saturate that fast and thus do not give you near zero gradients early on in learning.
...
To train the model, I used an Adam optimizer and the following hyperparameter:
* batch size: 128
* number of epochs: 60
